...
router.post('/createUser', [
    ...
    // body('profileUrl', 'Url must be atleast 3 characters').isLength({ min: 3 }),
    ...
    try {
        ...
        user = await User.create({
            name: req.body.name,
            profileUrl: "https://firebasestorage.googleapis.com/v0/b/tagit-71258.appspot.com/o/posts%2Fuser_profile_default.pngac330b38-f3bc-4e58-bd7f-3d21c784995c?alt=media&token=00bcfac6-2c05-434c-b5c9-9faeca3fefb3",
...
router.put('/updateUser', fetch_user, async (req, res) => {
    try {
        userId = req.user.id;
        const { status, college, profileUrl } = req.body;//destructuring
        const newUser = {};
